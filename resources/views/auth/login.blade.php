    ...
    <div class="card-body login-card-body">
      ...
      <div class="social-auth-links text-center mb-3">
        ...
        @if (Route::has('password.request'))
          <a class="btn btn-block btn-danger" href="{{ route('password.request') }}">I forgot my password</a>
        @endif
        <a class="btn btn-block btn-primary" href="#" class="text-center">Register a new membership</a>
      </div>
    </div>
    <!-- /.login-card-body -->
  </div>
